...
import { Mail, ArrowLeft, CheckCircle, Shield, BarChart3 } from 'lucide-react';
import { ImageWithFallback } from '@/app/components/figma/ImageWithFallback';
import { LOGO_FULL } from '@/lib/logo';

export function ManagerForgotPassword() {
      ...
      <div className="w-full max-w-6xl relative z-10 grid md:grid-cols-2 gap-12 items-center">
        ...
        <div className="hidden md:block space-y-8 animate-fade-in-up">
          ...
          <div className="space-y-6">
            ...
            <p className="text-lg text-slate-300 leading-relaxed">
              Reset your password and get back to managing your fleet
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <FeatureCard
              ...
              description="Get back to managing your fleet analytics"
        ...
        <div className="w-full animate-fade-in-up" style={{ animationDelay: '100ms' }}>
          ...
          <div className="md:hidden text-center mb-8">
            ...
            <p className="text-slate-400 text-sm">Manager Portal - Reset Password</p>
          </div>
