...
import { ManagerEditProfile } from '@/app/pages/manager/ManagerEditProfile';
      ...
      <InspectionProvider>
        <BrowserRouter>
          <Routes>
            ...
            <Route path="/manager/profile/edit" element={<ManagerLayout><ManagerEditProfile /></ManagerLayout>} />
            <Route path="/manager/profile/change-password" element={<ManagerLayout><ChangePassword /></ManagerLayout>} />
